...
public class GetAllExperienceBusiness implements Business<Dto, Result> {
    private final ExperienceProvider experienceProvider;

    @Override
    public Result execute(Dto input) {
        return GetAllExperienceBusinessMapper.INSTANCE.toResult(
                experienceProvider.getAllExperience(input.getUserId()));
    }
    ...
    @Mapper
    public interface GetAllExperienceBusinessMapper {
        GetAllExperienceBusinessMapper INSTANCE =
                Mappers.getMapper(GetAllExperienceBusinessMapper.class);
        ...
        GetAllExperienceBusiness.Result.Experience.QuestionList.Question toQuestion(
                QuestionVo questionVo);

        List<GetAllExperienceBusiness.Result.Experience.QuestionList.Question> toQuestionListQuestion(
        ...
        GetAllExperienceBusiness.Result.Experience.QuestionList toQuestionList(
                QuestionVoList questionVoList);

        @Mapping(source = "questionVoList", target = "questionList")
        GetAllExperienceBusiness.Result.Experience toExperience(ExperienceVo experienceVo);

        @Mapping(source = "totalCount", target = "totalCount")
        @Mapping(source = "experienceVoList", target = "experienceList")
        GetAllExperienceBusiness.Result toResult(ExperienceVoList experienceVoList);
    }
}
